...
EditorScene::EditorScene( GLRenderWidget* widget, QObject *parent, QString modelFileName ) :
  Scene( parent ),
  m_widget( widget ),
...
void EditorScene::initialize()
{
    ...
    textures.insert( "stars", m_widget->bindTexture( starsImage ) );

    QImage blocksImage( QString( SPACECRAFT_PATH ) + "/images/block_faces.png" );
    textures.insert( "block_faces", m_widget->bindTexture( blocksImage ) );
...
void EditorScene::draw()
{
  ...
  m_text.add( "fps\t", m_widget->getFPS() );
