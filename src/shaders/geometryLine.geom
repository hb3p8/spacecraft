...
{	
	...
	vec4 viewPos000proj = projectionMatrix * viewPos000;
	vec4 viewPos001proj = projectionMatrix * viewPos001;
	vec4 viewPos011proj = projectionMatrix * viewPos011;
	vec4 viewPos010proj = projectionMatrix * viewPos010;
	vec4 viewPos100proj = projectionMatrix * viewPos100;
	vec4 viewPos101proj = projectionMatrix * viewPos101;
	vec4 viewPos111proj = projectionMatrix * viewPos111;
	vec4 viewPos110proj = projectionMatrix * viewPos110;
