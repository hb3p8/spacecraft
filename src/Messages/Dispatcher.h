...
public:
    ...
    inline void do_dispatch(qint32 type_id, QDataStream & stream, Handler & handler)
    {
...
public:
    template <typename Handler>
    inline void do_dispatch(qint32, QDataStream &, Handler &)
    {
...
public:
    ...
    //! \param  handler     Message handler instance.
    template <typename Handler>
    inline void dispatch(QDataStream & stream, Handler & handler)
    {
        qint32 type_id;
        stream >> type_id;
